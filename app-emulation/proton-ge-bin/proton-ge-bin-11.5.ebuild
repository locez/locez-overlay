...
SRC_URI="https://github.com/GloriousEggroll/proton-ge-custom/releases/download/GE-Proton${MY_PV}/GE-Proton${MY_PV}-x86_64.tar.gz"

S="${WORKDIR}/GE-Proton${MY_PV}-x86_64"
